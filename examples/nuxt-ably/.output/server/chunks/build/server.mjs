import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, createElementBlock, ref, createApp, watch, isVNode, createCommentVNode, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, withCtx, Suspense, nextTick, Fragment, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { p as parseURL$1, e as encodePath$1, m as decodePath, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, t as getContext, $ as $fetch, v as defu, x as createHooks, c as createError$1, y as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_Hrd0X1wcINrpehqro3gv5MnfA8tiRX7OB74TpMCt4eU = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Ccuwk2Y7.mjs')
  }
];
...
const revive_payload_server_GHJ2sjp2FNwXvgv8t7pUzSANCLl3vQn4cRmIS6v3Q1k = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_Hrd0X1wcINrpehqro3gv5MnfA8tiRX7OB74TpMCt4eU,
  plugin,
  revive_payload_server_GHJ2sjp2FNwXvgv8t7pUzSANCLl3vQn4cRmIS6v3Q1k,
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.21.9_@biomejs+biome@1.9.4_@types+node@22.20.1_@vue+compiler-sfc@3.5.40_cac@6.7.14_db0@_2xi6lnvf2o7jgcjolcxfyl2o6u/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bd8bf-lq.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CQ4NkDGj.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.21.9_@biomejs+biome@1.9.4_@types+node@22.20.1_@vue+compiler-sfc@3.5.40_cac@6.7.14_db0@_2xi6lnvf2o7jgcjolcxfyl2o6u/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.21.9_@biomejs+biome@1.9.4_@types+node@22.20.1_@vue+compiler-sfc@3.5.40_cac@6.7.14_db0@_2xi6lnvf2o7jgcjolcxfyl2o6u/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, sanitizeTag as s, useRouter as u };
